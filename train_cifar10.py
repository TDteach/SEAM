...
def prepare_dataset(home_dir='.'):
    ...
    trainset = torchvision.datasets.CIFAR10(
        root=home_dir+'/data', train=True, download=True, transform=transform_train)

    testset = torchvision.datasets.CIFAR10(
        root=home_dir+'/data', train=False, download=True, transform=transform_test)
