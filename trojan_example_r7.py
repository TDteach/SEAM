...
def deal_one_sentence(original_words, original_labels, tokenizer, max_input_length, classification_model, device,
                      use_amp=False, print_out=False):
    # Select your preference for tokenization
    input_ids, attention_mask, labels, labels_mask = tokenize_and_align_labels(tokenizer, original_words,
